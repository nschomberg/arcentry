(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("arcentry", [], factory);
	else if(typeof exports === 'object')
		exports["arcentry"] = factory();
	else
		root["arcentry"] = factory();
...
var _document = _interopRequireDefault(__webpack_require__(/*! ./models/document */ "./src/models/document.js"));

var _object = _interopRequireDefault(__webpack_require__(/*! ./models/object */ "./src/models/object.js"));
  ...
  _createClass(Client, [{
    ...
    get: function get() {
      if (!this._cache.client) {
        ...
        client.defaults.headers.common.Authorization = "Bearer ".concat(this.apiKey);
    ...
    get: function get() {
      if (!this._cache.document) {
        this._cache.document = new _document.default(this.client);
      }
    ...
    get: function get() {
      if (!this._cache.object) {
        this._cache.object = new _object.default(this.client);
      }
...
function () {
  ...
  _createClass(DocumentModel, [{
    ...
    value: function get(documentId) {
      return this.client.get("/doc/".concat(documentId));
    }
  }, {
    key: "client",
    get: function get() {
...
function () {
  ...
  _createClass(ObjectModel, [{
    ...
    value: function list(documentId) {
      return this.client.get("/doc/".concat(documentId, "/obj"));
    } // https://arcentry.com/api-docs/#get-properties-for-an-object

  }, {
    key: "get",
    value: function get(documentId, objectId) {
      return this.client.get("/doc/".concat(documentId, "/obj/").concat(objectId));
    } // https://arcentry.com/api-docs/#retrieve-objects-by-selector

  }, {
    key: "getWhere",
    value: function getWhere(documentId, selector) {
      return this.client.get("/doc/".concat(documentId, "/obj/where/").concat(ObjectModel.generateSelector(selector)));
    } // https://arcentry.com/api-docs/#create-a-new-object

  }, {
    key: "create",
    value: function create(documentId, body) {
      return this.client.post("/doc/".concat(documentId, "/obj"), body);
    } // https://arcentry.com/api-docs/#set-properties-for-an-object

  }, {
    key: "update",
    value: function update(documentId, objectId, body) {
      return this.client.post("/doc/".concat(documentId, "/obj/").concat(objectId), body);
    } // https://arcentry.com/api-docs/#update-multiple-objects-matching-a-selector

  }, {
    key: "updateWhere",
    value: function updateWhere(documentId, selector, body) {
      return this.client.post("/doc/".concat(documentId, "/obj/where"), _extends({}, body, {
        selector: selector
      }));
    ...
    key: "delete",
    value: function _delete(documentId, objectId) {
      return this.client.post("/doc/".concat(documentId, "/obj/").concat(objectId, "/delete"));
    }
  }, {
    key: "client",
    get: function get() {
    ...
    value: function generateSelector(array) {
...
//# sourceMappingURL=arcentry.js.map